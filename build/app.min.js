...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_camera__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/camera */ \"./js/modules/camera.js\");\n/* harmony import */ var _modules_canvas_2d__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/canvas_2d */ \"./js/modules/canvas_2d.js\");\n/* harmony import */ var _modules_floor_plan__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/floor_plan */ \"./js/modules/floor_plan.js\");\n/* harmony import */ var _modules_lighting__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/lighting */ \"./js/modules/lighting.js\");\n/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/map */ \"./js/modules/map.js\");\n/* harmony import */ var _modules_materials__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/materials */ \"./js/modules/materials.js\");\n/* harmony import */ var _modules_player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/player */ \"./js/modules/player.js\");\n/* harmony import */ var _modules_renderer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/renderer */ \"./js/modules/renderer.js\");\n/* harmony import */ var _modules_scene__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/scene */ \"./js/modules/scene.js\");\n/* harmony import */ var _modules_surface__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/surface */ \"./js/modules/surface.js\");\n/* harmony import */ var _ui_archive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ui/archive */ \"./js/ui/archive.js\");\n/* harmony import */ var _ui_menu__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ui/menu */ \"./js/ui/menu.js\");\n/* harmony import */ var _utils_is_safari_mobile__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/is_safari_mobile */ \"./js/utils/is_safari_mobile.js\");\n/** App entry */\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nclass App {\n  constructor() {\n    this.active = false;\n    this.modules = {\n      renderer: new _modules_renderer__WEBPACK_IMPORTED_MODULE_7__[\"default\"](),\n      scene: new _modules_scene__WEBPACK_IMPORTED_MODULE_8__[\"default\"](),\n      player: new _modules_player__WEBPACK_IMPORTED_MODULE_6__[\"default\"](),\n      camera: new _modules_camera__WEBPACK_IMPORTED_MODULE_0__[\"default\"](),\n      floorPlan: new _modules_floor_plan__WEBPACK_IMPORTED_MODULE_2__[\"default\"](),\n      lighting: new _modules_lighting__WEBPACK_IMPORTED_MODULE_3__[\"default\"](),\n      map: new _modules_map__WEBPACK_IMPORTED_MODULE_4__[\"default\"](),\n      materials: new _modules_materials__WEBPACK_IMPORTED_MODULE_5__[\"default\"](),\n      surface: new _modules_surface__WEBPACK_IMPORTED_MODULE_9__[\"default\"](),\n      canvas2d: new _modules_canvas_2d__WEBPACK_IMPORTED_MODULE_1__[\"default\"](),\n      archive: new _ui_archive__WEBPACK_IMPORTED_MODULE_10__[\"default\"](),\n      menu: new _ui_menu__WEBPACK_IMPORTED_MODULE_11__[\"default\"]()\n    };\n    this.bind();\n    this.timer = {\n      previous: performance.now()\n    };\n    this.loop();\n  }\n\n  bind() {\n    // bind modules\n    Object.keys(this.modules).forEach(key => {\n      if (this.modules[key].bind) {\n        this.modules[key].bind(this);\n      }\n    }); // trigger resize after orientationchange\n\n    window.addEventListener('orientationchange', () => {\n      setTimeout(() => {\n        window.dispatchEvent(new Event('resize'));\n      }, 500);\n    }); // safari fix\n\n    if (Object(_utils_is_safari_mobile__WEBPACK_IMPORTED_MODULE_12__[\"default\"])()) {\n      document.querySelectorAll('.fix-safari').forEach(el => {\n        el.classList.add('safari');\n      });\n    }\n  }\n\n  start() {\n    this.timer.previous = performance.now();\n    this.active = true;\n  }\n\n  pause() {\n    this.active = false;\n  }\n\n  loop() {\n    requestAnimationFrame(() => {\n      this.loop();\n    });\n\n    if (this.active) {\n      const now = performance.now();\n      const delta = Math.min(0.1, (now - this.timer.previous) / 1000);\n      this.timer.previous = now; // update modules\n\n      Object.keys(this.modules).forEach(key => {\n        if (this.modules[key].update) {\n          this.modules[key].update(delta);\n        }\n      }); // render\n\n      this.modules.renderer.render(delta);\n      this.modules.surface.render();\n    }\n  }\n\n}\n\nwindow.onload = () => {\n  const app = new App();\n};\n\n//# sourceURL=webpack://COMGALLERY/./js/app.js?");
