...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/scene */ \"./js/modules/scene.js\");\n/* harmony import */ var _modules_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/renderer */ \"./js/modules/renderer.js\");\n/* harmony import */ var _modules_surface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/surface */ \"./js/modules/surface.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ \"./js/utils/index.js\");\n/** Gallery entry point and main loop. */\n\n\n\n\n\nclass App {\n  constructor() {\n    this.active = false;\n    this.isMobile = _utils__WEBPACK_IMPORTED_MODULE_3__[\"detectMobileAndTablet\"]();\n    this.isMobileExclusive = _utils__WEBPACK_IMPORTED_MODULE_3__[\"detectMobileOnly\"]();\n    this.menu = new _utils__WEBPACK_IMPORTED_MODULE_3__[\"Menu\"](this, this.isMobile, () => {\n      this.load();\n    });\n    this.maxTimeDelta = 0.1; // load site or defer load (mobile)\n    //if (!this.isMobile) {\n\n    this.load(); //}\n    // events\n\n    window.addEventListener('resize', () => {\n      this.resize();\n    });\n    window.addEventListener('orientationchange', () => {\n      setTimeout(() => {\n        this.resize();\n      }, 500);\n    }); // fix browser quirk\n\n    if (this.isMobileExclusive && _utils__WEBPACK_IMPORTED_MODULE_3__[\"detectMobileSafari\"]()) {\n      document.querySelectorAll('.fix-safari').forEach(el => {\n        el.classList.add('safari');\n      });\n    } // start\n\n\n    this.loop();\n  }\n\n  load() {\n    if (!this.loaded) {\n      this.loaded = true;\n      this.scene = new _modules_scene__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n      this.renderer = new _modules_renderer__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this, this.scene);\n      this.surface = new _modules_surface__WEBPACK_IMPORTED_MODULE_2__[\"default\"](this.scene, this.renderer, this.isMobile);\n      this.archive = new _utils__WEBPACK_IMPORTED_MODULE_3__[\"Archive\"](this);\n    }\n  }\n\n  resize() {\n    if (!this.isMobileExclusive) {\n      this.renderer.resize();\n      this.scene.resize();\n      this.surface.resize();\n    }\n  }\n\n  deactivate() {\n    this.active = false;\n  }\n\n  activate() {\n    this.active = true;\n    this.now = performance.now();\n  }\n\n  loop() {\n    requestAnimationFrame(() => {\n      this.loop();\n    });\n\n    if (this.active && this.loaded) {\n      const t = performance.now();\n      const delta = Math.min(this.maxTimeDelta, (t - this.now) / 1000);\n      this.now = t;\n      this.scene.update(delta);\n      this.surface.update(delta);\n      this.renderer.draw(delta);\n      this.surface.draw();\n    }\n  }\n\n}\n\nwindow.onload = () => {\n  const app = new App();\n};\n\n//# sourceURL=webpack://CLM/./js/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _world_camera__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./world/camera */ \"./js/modules/world/camera.js\");\n/* harmony import */ var _world_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./world/player */ \"./js/modules/world/player.js\");\n/* harmony import */ var _world_lighting__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./world/lighting */ \"./js/modules/world/lighting.js\");\n/* harmony import */ var _world_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./world/map */ \"./js/modules/world/map.js\");\n/** Scene & game logic. */\n\n\n\n\n\nclass Scene {\n  constructor() {\n    this.element = document.querySelector('#canvas-target');\n    this.width = window.innerWidth;\n    this.height = window.innerHeight;\n    this.scene = new THREE.Scene();\n    this.colliderSystem = new Collider.System();\n    this.player = new _world_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this);\n    this.camera = new _world_camera__WEBPACK_IMPORTED_MODULE_0__[\"default\"](this);\n    this.lighting = new _world_lighting__WEBPACK_IMPORTED_MODULE_2__[\"default\"](this);\n    this.map = new _world_map__WEBPACK_IMPORTED_MODULE_3__[\"default\"](this);\n  }\n\n  resize() {\n    const rect = this.element.getBoundingClientRect();\n    this.width = rect.width;\n    this.height = rect.height;\n    this.camera.resize();\n  }\n\n  reloadExhibition() {\n    this.map.reloadInstallation();\n    this.lighting.reloadExhibition();\n    this.player.resetPosition();\n  }\n\n  update(delta) {\n    this.player.update(delta);\n    this.camera.update(delta);\n    this.map.update(delta);\n  }\n\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Scene);\n\n//# sourceURL=webpack://CLM/./js/modules/scene.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/** Artwork config. TODO: refactor this to CMS. */\nconst config = {\n  artworkPositions: [// 32 Artworks in total\n  // brick wall (8)\n  {\n    x: -24,\n    y: 4,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: -10.5,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: -8,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: -5.5,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 5.5,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 8,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 10.5,\n    y: 3.5,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 24,\n    y: 4,\n    z: 23,\n    nx: 0,\n    nz: -1\n  }, // central block A (6)\n  {\n    x: -12,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, {\n    x: -8,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, {\n    x: -4,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 4,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 8,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 12,\n    y: 3.5,\n    z: 8,\n    nx: 0,\n    nz: 1\n  }, // end walls (6)\n  {\n    x: -31,\n    y: 4,\n    z: 14,\n    nx: 1,\n    nz: 0\n  }, {\n    x: -29.5,\n    y: 4,\n    z: 6,\n    nx: 1,\n    nz: 0\n  }, {\n    x: -31,\n    y: 4,\n    z: -2,\n    nx: 1,\n    nz: 0\n  }, {\n    x: 32,\n    y: 4,\n    z: 14,\n    nx: -1,\n    nz: 0\n  }, {\n    x: 30,\n    y: 4,\n    z: 6,\n    nx: -1,\n    nz: 0\n  }, {\n    x: 32,\n    y: 4,\n    z: -2,\n    nx: -1,\n    nz: 0\n  }, // central block B (6)\n  {\n    x: -12,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, {\n    x: -8,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, {\n    x: -4,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 4,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 8,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, {\n    x: 12,\n    y: 3.5,\n    z: 4,\n    nx: 0,\n    nz: -1\n  }, // white wall downstairs (2)\n  {\n    x: -8,\n    y: 3.5,\n    z: -11.5,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 8,\n    y: 3.5,\n    z: -11.5,\n    nx: 0,\n    nz: 1\n  }, // upstairs (4)\n  {\n    x: -24,\n    y: 11,\n    z: -11,\n    nx: 0,\n    nz: 1\n  }, {\n    x: -8,\n    y: 11,\n    z: -11.5,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 8,\n    y: 11,\n    z: -11.5,\n    nx: 0,\n    nz: 1\n  }, {\n    x: 24,\n    y: 11,\n    z: -11,\n    nx: 0,\n    nz: 1\n  }]\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (config);\n\n//# sourceURL=webpack://CLM/./js/modules/ui/artwork/config.js?");

/***/ }),

/***/ "./js/modules/ui/artwork/floor_plan.js":
/*!*********************************************!*\
  !*** ./js/modules/ui/artwork/floor_plan.js ***!
  \*********************************************/
/*! exports provided: default */
...
/*!***************************!*\
  !*** ./js/utils/index.js ***!
  \***************************/
/*! exports provided: detectMobileOnly, detectMobileSafari, detectMobileAndTablet, Menu, Archive */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mobile_check__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mobile_check */ \"./js/utils/mobile_check.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"detectMobileOnly\", function() { return _mobile_check__WEBPACK_IMPORTED_MODULE_0__[\"detectMobileOnly\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"detectMobileSafari\", function() { return _mobile_check__WEBPACK_IMPORTED_MODULE_0__[\"detectMobileSafari\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"detectMobileAndTablet\", function() { return _mobile_check__WEBPACK_IMPORTED_MODULE_0__[\"detectMobileAndTablet\"]; });\n\n/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./menu */ \"./js/utils/menu.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Menu\", function() { return _menu__WEBPACK_IMPORTED_MODULE_1__[\"Menu\"]; });\n\n/* harmony import */ var _archive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./archive */ \"./js/utils/archive.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Archive\", function() { return _archive__WEBPACK_IMPORTED_MODULE_2__[\"Archive\"]; });\n\n\n\n\n\n//# sourceURL=webpack://CLM/./js/utils/index.js?");
